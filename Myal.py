...
options, remainder = getopt.getopt(sys.argv[1:], 'rE:rS:e:s:v:pE:pS:pM:o:h',
                                   ['rutaE=', 'rutaS=', 'entrenar', 'sensibilidad', 'valorar', 'pickleE=', 'pickleS=',
                                    'pickleM=', 'salida', 'help'])
rutaE, rutaS, entrenar, sensibilidad, valorar, modoPickleE, modoPickleS, modoPickleMa = (
...
for opt, arg in options:
    if opt in ('-rE', '--rutaE'):
        ...
        print(
            "La variable de linea de comandos no es valida \n'rE:rS:e:s:v:pE:pS:pM:o:h'\n['rutaE=', 'rutaS=', 'entrenar', 'sensibilidad', 'valorar', 'pickleE=', 'pickleS=', 'pickleM=', 'salida', 'help'])")
...
if entrenar:
    ...
    if modoPickleE == False:
        ...
        for archivo in listaArchivos:
            ...
            for j in range(numeroVentanas):
                ...
                variableLocal[j, 4], variableLocal[j, 5], variableLocal[j, 6], variableLocal[
                    j, 7] = funciones.calcularfftyee(datosTrabajo, freq)
                variableLocal[j, 8], variableLocal[j, 9], variableLocal[j, 10] = funciones.calcularestadisticos(
                    datosTrabajo)
    ...
    # Una vez entranado calculamos como saldra el resultado con el dataset de sensibilidad
